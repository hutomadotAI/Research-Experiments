...
from base_model.encoder import Encoder
from base_model.decoder import BaseDecoder
...
class BaseModel(object):
    def __init__(self, embeddings, output_types, output_shapes, **kwargs):
        ...
        self.decoder = BaseDecoder(seed=kwargs['random_seed'])
        self.question_embedding = None
        self.context_embedding = None
        self.logger = logging.getLogger('phrase_level_qa.qa_system.base_model')
    ...
    def prepare_data(self):
        self.context_ids, self.question_ids, self.labels, self.qa_ids, _, _ =\
    ...
    def setup_system(self):
        context, question = self.encoder.encode(
            ...
            (self.c_len, self.q_len), self.is_train)
