...
from cudnn_match_lstm.encoder import Encoder
from cudnn_match_lstm.decoder import Decoder


class CudnnMatchLSTM(object):
    def __init__(self, embeddings, output_types, output_shapes, **kwargs):
        self.model_name = 'CudnnMatchLSTM'
        self.kwargs = kwargs
        ...
        self.logger = logging.getLogger('phrase_level_qa.qa_system.cudnn_match_lstm')

    def setup_model(self):
        with tf.variable_scope('CudnnMatchLSTM'):
            self.prepare_data()
